package com.Basketeer.Product_Service.filter;
...
import com.Basketeer.Product_Service.JwtService;
...
public class JwtRequestFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if(path.startsWith("/api/product/image") || path.startsWith("/api/product/swagger-ui") || path.startsWith("/api/product/api-docs")) {
